...
import { LayoutDashboard, Package, ShoppingBag, MessageSquare, Settings, BarChart3, Bot, Zap } from "lucide-react";
    ...
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col h-screen">
      ...
      <div className="px-4 py-3 border-b border-gray-100">
        <div className={cn(
          ...
          seller.agentStatus === "active" ? "bg-green-50 text-green-700" :
          seller.agentStatus === "provisioning" ? "bg-yellow-50 text-yellow-700" :
          "bg-gray-100 text-gray-500"
        )}>
          <Bot className="w-3.5 h-3.5" />
          {seller.agentStatus === "active" && "AI Agent Aktif ✅"}
          {seller.agentStatus === "provisioning" && "Sedang menyiapkan..."}
      ...
      <div className="px-4 py-4 border-t border-gray-100">
        <p className="text-xs text-gray-400">Demo Mode · Nemu AI MVP</p>
      </div>
    </aside>
  );
}
